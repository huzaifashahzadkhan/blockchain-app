...
const Input = ({ placeholder, name, type, value, handleChange }) => (
  <input
    ...
    className="my-2 w-full rounded-sm p-2  border hover:border-orange-400   text-sm "
  />
);
    ...
    <div className="flex w-full justify-center items-center">
      <div className="flex md:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col md:mr-10">
          <h1 className="text-3xl sm:text-5xlpy-1">
          ...
          {!currentAccount && (
            <button
              ...
              className="flex flex-row justify-center items-center my-5 border border-orange-400 hover:bg-[#F48245] p-3 rounded-full cursor-pointer "
            >
        ...
        <div className="flex flex-col flex-1 items-center justify-start w-full md:mt-0 mt-10">
          <div className="p-3 flex justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 bg-[#F48245] .white-glassmorphism ">
